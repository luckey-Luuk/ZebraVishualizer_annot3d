...
# import matplotlib.pyplot as plt # lijkt overbodig
import os 
# import models # lijkt overbodig
...
class AnnotationSpace3D():
	...
	def __init__(self, npimages, dimensions, color_rgba):
		...
		# self.MAX_UNDOS = 10 # lijkt overbodig
		# self.undo_stack = [] # state history undo type, tuples (plane, npspace slice, npspace rgba slice) (slice of voxels) FOR ALL PLANES # lijkt overbodig
		self.color_rgba = color_rgba
		# self.server_url = '' # lijkt overbodig
		# self.predict_mode = 'local' # lijkt overbodig
		# self.model = None # lijkt overbodig
	...
	# def load_model_weights(self, model_weights_file): # hdf5 file # lijkt overbodig
	...
	# def set_server_url(self, url): # lijkt overbodig
	# 	self.server_url = url
	# 	self.predict_mode = 'server'


	# def model_predict(self, p, cs): # lijkt overbodig
	...
	# def mergeload(self, path_list): # lijkt overbodig
	...
	# def save_history(self, plane, curr_slide): # lijkt overbodig
	...
	# def undo_history(self): # lijkt overbodig
	...
	# def get_slice(self, p, cs): # lijkt overbodig
	# 	if p == 'xy':
	...
	# def get_src_slice(self, p, cs): # lijkt overbodig
	# 	if p == 'xy':
	...
	# def clear_slice(self, p, cs): # lijkt overbodig
	# 	w,h,d = self.dim
	# 	if p == 'xy':
